...
// 	('o.grigorescu@hotmail.com','Ovi','Grig','9055723422','21 McCurdy Road, Guelph, ON', 'Password');";
	...
	$dbSchema['Insert Sarb'] =
		"INSERT INTO User_Profile(EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES
			('sarbajoymajumdar@gmail.com','Sarbajoy','Majumdar','password');";

	$dbSchema['Insert Vik'] =
				"INSERT INTO User_Profile(EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES
					('vikram.sraon@gmail.com','Vik','Sraon','password');";

	$dbSchema['Insert Sumit'] =
						"INSERT INTO User_Profile(EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES
							('sumitbansal894@gmail.com','Sumit','Bansal','password');";

	$dbSchema['Insert Calvin'] =
								"INSERT INTO User_Profile(EMAIL, FIRST_NAME, LAST_NAME, PASSWORD) VALUES
									('cp5956@gmail.com','Calvin','Poon','password');";

	$dbSchema['Insert Sample1'] =
									"INSERT INTO Weight_Table(WEIGHT, DATE_ADDED) VALUES
										('0.95kg', '2010-04-30 14:53:27');";
	$dbSchema['Insert Sample2'] =
										"INSERT INTO Weight_Table(WEIGHT) VALUES
											('0.69kg');";
